...
#graph = SAME.make_unipartite_community_graph(N_groups,N_individuals,p_dist,g_dist)
end
...
spin_dist_ts = map( vm_i -> get_spin_dist(vm_i,my_hypergraph,my_vertex_attribues),vm_ts)
